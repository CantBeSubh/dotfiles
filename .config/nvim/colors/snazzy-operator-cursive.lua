-- snazzy-operator-cursive.lua — generated from Colorscheme Lab (v5 — operator + cursive)
-- Drop in ~/.config/nvim/colors/snazzy-operator-cursive.lua
-- Then set colorscheme = "snazzy-operator-cursive" in your LazyVim opts.
--
-- ┌─ CURSIVE ITALICS ─────────────────────────────────────────────┐
...
vim.g.colors_name = "snazzy-operator-cursive"
