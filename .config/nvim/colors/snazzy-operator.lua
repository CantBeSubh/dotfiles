-- snazzy-operator.lua — generated from Colorscheme Lab (v3 — snazzy operator)
-- Drop in ~/.config/nvim/colors/snazzy-operator.lua
-- Then set colorscheme = "snazzy-operator" in your LazyVim opts.
...
vim.g.colors_name = "snazzy-operator"
...
hi("@keyword.coroutine", { fg = c.magenta }) -- async/await
...
-- Flat imports: force all imported names to fg regardless of case.
-- Treesitter side: imported symbols land under these groups.
hi("@module", { fg = c.fg })
hi("@module.builtin", { fg = c.fg })
hi("@variable.import", { fg = c.fg })
-- LSP semantic tokens win over Treesitter where an LSP is attached.
-- The .import / .defaultLibrary modifiers cover named + default imports.
hi("@lsp.mod.import", { fg = c.fg })
hi("@lsp.typemod.namespace.import", { fg = c.fg })
hi("@lsp.typemod.class.import", { fg = c.fg }) -- PascalCase components
hi("@lsp.typemod.function.import", { fg = c.fg })
hi("@lsp.typemod.variable.import", { fg = c.fg })
hi("@lsp.typemod.type.import", { fg = c.fg })
